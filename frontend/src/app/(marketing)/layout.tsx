    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-50 p-4 dark:bg-slate-950">
      ...
      <div className="w-full max-w-md">
        ...
        <footer className="mt-6 text-center text-xs text-slate-400">
          ...
          <a href="https://cloudon.gr" target="_blank" rel="noopener noreferrer" title="Powered by CloudOn" className="mt-3 flex items-center justify-center gap-2 opacity-70 transition hover:opacity-100">
