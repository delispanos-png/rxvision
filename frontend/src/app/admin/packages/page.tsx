...
type Pkg = {
  ...
  trial_days?: number; seats?: number; included_users?: number; ai_included?: number; ai_included_period?: string; ai_budget_cents?: number;
