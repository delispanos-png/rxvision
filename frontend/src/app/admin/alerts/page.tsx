      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        <div className="mb-4 rounded-xl bg-slate-50 p-3 text-sm text-slate-600 dark:bg-slate-800/50 dark:text-slate-300">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5 text-[13px]">
            ...
            <li>✅ <b>Πρώτος συγχρονισμός ΗΔΥΚΑ</b> νέου πελάτη (μία φορά, όταν έρθουν τα πρώτα δεδομένα).</li>
            <li>⚠️ <b>Συστημικό πρόβλημα</b> — αν δεν δουλεύει <b>κανένας</b> συγχρονισμός για &gt;1 ώρα, ή πρόβλημα υποδομής (server down). <i>(σύντομα + παραμετροποιήσιμο)</i></li>
          </ul>
        </div>
