          ...
          <div className="rounded-2xl border border-brand-100 bg-gradient-to-br from-brand-50 to-white p-5 dark:border-brand-900/40 dark:from-brand-950/20 dark:to-slate-900">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {advice?.ok && (advice.cached
                  ? <span className="inline-flex items-center gap-1 rounded-full bg-emerald-100 px-2.5 py-0.5 text-[11px] font-semibold text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300" title={t("Δεν ξαναρωτήθηκε το AI — οι παθήσεις/φάρμακα δεν άλλαξαν.", "AI not re-queried — conditions/medicines unchanged.")}>💾 {t("Από βάση γνώσεων", "From knowledge base")}{advice.generated_at ? ` · ${fmtDate(advice.generated_at)}` : ""}</span>
                  : <span className="inline-flex items-center gap-1 rounded-full bg-violet-100 px-2.5 py-0.5 text-[11px] font-semibold text-violet-700 dark:bg-violet-900/40 dark:text-violet-300" title={t("Μόλις δημιουργήθηκε από το AI και αποθηκεύτηκε.", "Freshly generated by AI and saved.")}>✨ {t("Νέες από AI", "Fresh from AI")}</span>)}
              </div>
