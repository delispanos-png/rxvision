...
_DEFAULTS: list[dict] = [
    ...
    {"_id": "daily_coach", "name": "Ο Σύμβουλός σου", "icon": "🧭", "category": "intelligence",
     ...
     # ΥΠΟ ΚΑΤΑΣΚΕΥΗ: active=False ⇒ δεν εμφανίζεται στον κατάλογο και δεν αγοράζεται.
     # Δοκιμάζεται ΜΟΝΟ στον demo tenant (module override). Θα ανοίξει όταν ολοκληρωθεί.
     "price_monthly": 2500, "price_yearly": 25000, "active": False,
