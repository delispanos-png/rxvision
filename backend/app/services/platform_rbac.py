...
_ADMIN: dict[tuple[str, str], str] = {
    ...
    ("GET", "/ai-usage/{tenant_id}"): "tenants:read",
    ("GET", "/catalog-seed/stuck"): "tenants:read",
    ("POST", "/catalog-seed/stuck/retry"): "tenants:items_copy",
    ("POST", "/catalog-seed/copy"): "tenants:items_copy",
    ("GET", "/release-notes"): "content:read",
    ("PUT", "/release-notes"): "content:write",
    ("POST", "/release-notes/{version}/publish"): "content:write",
    ("DELETE", "/release-notes/{version}"): "content:write",
