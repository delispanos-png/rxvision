...
ΜΟΝΟ ΔΥΝΑΤΟΤΗΤΕΣ, ΠΟΤΕ ΔΙΟΡΘΩΣΕΙΣ (ρητή οδηγία ιδιοκτήτη 25/09/2026): η σημείωση απαντά στο
«τι μπορώ να κάνω τώρα που δεν μπορούσα». Αν η αλλαγή απαντά στο «τι δούλευε λάθος», ΔΕΝ παίρνει
ούτε σημείωση ούτε bump έκδοσης — ανεβαίνει σιωπηλά. Σε μεικτή αλλαγή, γράφεται ΜΟΝΟ το κομμάτι
της δυνατότητας.

ΥΦΟΣ (ρητό): «Προσθέσαμε αυτό, θα το βρείτε εδώ. Προσθέσαμε εκείνο, θα το κάνει έτσι.»
Τίτλος = «Προσθέσαμε <τι>» · σώμα = τι κάνει σε μία-δύο προτάσεις · `where` = πού ακριβώς.
ΟΧΙ αφήγηση, ΟΧΙ «γιατί», ΟΧΙ νούμερα ελέγχου, ΟΧΙ αναφορά σε τι δούλευε λάθος.
